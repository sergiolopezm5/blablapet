...
<html class="fixed sidebar-light  sidebar-left-collapsed">
	<head>
		...
		<title>Mensajes - BlaBlaPet</title>
						...
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="folder">
							...
							<menu id="content-menu" class="inner-menu" role="menu">
								...
								<div class="mailbox-email-header mb-lg">
									...
									<p class="mt-lg mb-none text-md">From <a href="#">Okler Themes</a> to <a href="#">You</a>, started on July, 05, 2016</p>
								</div>
									...
									<div class="mailbox-email-screen">
										<div class="panel">
											...
											<div class="panel-footer">
												<p class="m-none"><small>July 07, 2016. 9:51pm</small></p>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div class="panel-footer">
												<p class="m-none"><small>July 06, 2016. 03:26pm</small></p>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div class="panel-footer">
												<p class="m-none"><small>July 05, 2016. 10:03am</small></p>
											</div>
										</div>
									</div>
